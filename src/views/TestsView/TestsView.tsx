...
const TestsView: React.FC = () => {
	...
	const {projects, fetchProjects, createTestCase, generateTestCaseWithAI} =
		useProjectStore()
	...
	const handleGenerateWithAI = async (
		...
		try {
			await generateTestCaseWithAI(selectedSuiteId, prompt, dependencies)
				...
				<div className='flex flex-col md:flex-row gap-4 mb-4'>
					...
					<div className='flex gap-2'>
						...
						<select
							...
							value={typeFilter}
							onChange={(e) =>
								setTypeFilter(e.target.value as TestCaseType | 'all')
							}
						>
									...
									<td className='px-6 py-4 whitespace-nowrap text-right text-sm font-medium'>
										<div className='flex justify-end gap-2'>
											...
											<ActionButton
												...
												onClick={() =>
													navigate(
														`/projects/${testCase.projectId}/test-cases/${testCase.id}`
													)
												}
											>
												View
